...
function Subheading({ children }: { children: React.ReactNode }) {
  return (
    <h3 className="mt-6 text-lg font-semibold text-[#0C1F3F]">{children}</h3>
  );
}
...
const tocItems: { id: string; label: string }[] = [
  ...
  { id: "ppyes", label: "12. Privacy policy" },
  ...
  { id: "electronic", label: "22. Electronic communications, transactions, and signatures" },
  { id: "california", label: "23. California users and residents" },
    ...
    <div className="bg-white">
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
        ...
        <section className="mt-10 space-y-4 text-sm leading-relaxed text-gray-700">
          ...
          <p>
            We are FieldSlate (<strong>&ldquo;Company&rdquo;</strong>,{" "}
            <strong>&ldquo;we&rdquo;</strong>, <strong>&ldquo;us&rdquo;</strong>,{" "}
            <strong>&ldquo;our&rdquo;</strong>), a company registered in
            California, United States at 322 Yates Dr, Santa Rosa, CA 95405.
          </p>
          <p>
            ...
            (the <strong>&ldquo;Site&rdquo;</strong>), as well as any other
            related products and services that refer or link to these legal
            terms (the <strong>&ldquo;Legal Terms&rdquo;</strong>) (collectively,
            the <strong>&ldquo;Services&rdquo;</strong>).
          </p>
          <p>
            FieldSlate is a web-based scheduling and league management platform
            for youth sports organizations. It allows league administrators to
            create and manage divisions, teams, game schedules, and practice
            assignments. FieldSlate is a subscription-based SaaS product
            intended for use by league administrators.
          </p>
          <p>
            You can contact us by phone at (+1) 415-250-8553, email at{" "}
            <a
            ...
            , or by mail to 322 Yates Dr, Santa Rosa, CA 95405, United States.
          </p>
          <p>
            These Legal Terms constitute a legally binding agreement made
            between you, whether personally or on behalf of an entity
            (<strong>&ldquo;you&rdquo;</strong>), and FieldSlate, concerning
        ...
        <section className="mt-12 space-y-4 text-sm leading-relaxed text-gray-700">
          <SectionHeading id="services" number={1}>Our services</SectionHeading>
          <p>
        ...
        <section className="mt-12 space-y-4 text-sm leading-relaxed text-gray-700">
          ...
          <p>
            ...
            &ldquo;AS IS&rdquo; for your internal business purpose only.
          </p>

          <Subheading>Your use of our Services</Subheading>
          <p>
            Subject to your compliance with these Legal Terms, including the{" "}
            <a href="#prohibited" className="text-[#22C55E] hover:underline">
              &ldquo;Prohibited activities&rdquo;
            </a>{" "}
          ...
          <p>
            ...
            the Services (&ldquo;Submissions&rdquo;), you agree to assign to us
        ...
        <section className="mt-12 space-y-4 text-sm leading-relaxed text-gray-700">
          <SectionHeading id="userreps" number={3}>User representations</SectionHeading>
          <p>
        ...
        {/* 4. USER REGISTRATION */}
        <section className="mt-12 space-y-4 text-sm leading-relaxed text-gray-700">
          <SectionHeading id="userreg" number={4}>User registration</SectionHeading>
          <p>
        ...
        <section className="mt-12 space-y-4 text-sm leading-relaxed text-gray-700">
          <SectionHeading id="purchases" number={5}>Purchases and payment</SectionHeading>
        ...
        {/* 6. SUBSCRIPTIONS */}
        <section className="mt-12 space-y-4 text-sm leading-relaxed text-gray-700">
          <SectionHeading id="subscriptions" number={6}>Subscriptions</SectionHeading>

          <Subheading>Billing and renewal</Subheading>
          <p>
            FieldSlate is billed on a per-season basis. Each season requires a
            new payment to activate. Subscriptions do not renew automatically.
            When you are ready to start a new season, you may purchase access
            at the then-current pricing. We may contact you by email to let
            you know when your season has ended and how to start a new one.
          </p>
        ...
        <section className="mt-12 space-y-4 text-sm leading-relaxed text-gray-700">
          <SectionHeading id="prohibited" number={7}>Prohibited activities</SectionHeading>
          <p>
          ...
          <ul className="ml-6 list-disc space-y-2">
            ...
            <li>
              ...
              graphics interchange formats (&ldquo;gifs&rdquo;), 1×1 pixels,
        ...
        <section className="mt-12 space-y-4 text-sm leading-relaxed text-gray-700">
          <SectionHeading id="ugc" number={8}>User generated contributions</SectionHeading>
          <p>
        ...
        <section className="mt-12 space-y-4 text-sm leading-relaxed text-gray-700">
          <SectionHeading id="license" number={9}>Contribution license</SectionHeading>
          <p>
        ...
        <section className="mt-12 space-y-4 text-sm leading-relaxed text-gray-700">
          <SectionHeading id="thirdparty" number={10}>
            Third-party websites and content
          </SectionHeading>
          <p>
            The Services may contain (or you may be sent via the Site) links
            to other websites (&ldquo;Third-Party Websites&rdquo;) as well as
            ...
            (&ldquo;Third-Party Content&rdquo;). Such Third-Party Websites and
            ...
            website to which you navigate from the Services or relating to
            any applications you use or install from the Services. Any
        ...
        <section className="mt-12 space-y-4 text-sm leading-relaxed text-gray-700">
          <SectionHeading id="sitemanage" number={11}>Services management</SectionHeading>
          <p>
        ...
        {/* 12. PRIVACY POLICY */}
        <section className="mt-12 space-y-4 text-sm leading-relaxed text-gray-700">
          <SectionHeading id="ppyes" number={12}>Privacy policy</SectionHeading>
          <p>
            ...
            <Link
              ...
              className="font-medium text-[#22C55E] hover:underline"
            >
              https://www.thefieldslate.com/privacy
            </Link>
        ...
        <section className="mt-12 space-y-4 text-sm leading-relaxed text-gray-700">
          <SectionHeading id="terms" number={13}>Term and termination</SectionHeading>
          <p>
        ...
        <section className="mt-12 space-y-4 text-sm leading-relaxed text-gray-700">
          <SectionHeading id="modifications" number={14}>
        ...
        {/* 15. GOVERNING LAW */}
        <section className="mt-12 space-y-4 text-sm leading-relaxed text-gray-700">
          <SectionHeading id="law" number={15}>Governing law</SectionHeading>
          <p>
        ...
        <section className="mt-12 space-y-4 text-sm leading-relaxed text-gray-700">
          <SectionHeading id="disputes" number={16}>Dispute resolution</SectionHeading>
          ...
          <p>
            ...
            &ldquo;Disputes&rdquo;) brought by either you or us (individually,
            a &ldquo;Party&rdquo; and collectively, the
          ...
          <p>
            ...
            Association (&ldquo;AAA&rdquo;) and, where appropriate, the
            AAA&rsquo;s Supplementary Procedures for Consumer Related
            Disputes (&ldquo;AAA Consumer Rules&rdquo;), both of which are
            available at the{" "}
            <a
            ...
            arbitration fees and expenses. The arbitration may be conducted
            ...
            the arbitration will take place in Sonoma County, California.
          ...
          <p>
            ...
            state and federal courts located in Sonoma County, California,
          ...
          <p>
            ...
            any way to the Services be commenced more than one (1) year after
        ...
        {/* 17. CORRECTIONS */}
        <section className="mt-12 space-y-4 text-sm leading-relaxed text-gray-700">
          <SectionHeading id="corrections" number={17}>Corrections</SectionHeading>
          <p>
        ...
        {/* 18. DISCLAIMER */}
        <section className="mt-12 space-y-4 text-sm leading-relaxed text-gray-700">
          <SectionHeading id="disclaimer" number={18}>Disclaimer</SectionHeading>
          <p>
        ...
        <section className="mt-12 space-y-4 text-sm leading-relaxed text-gray-700">
          <SectionHeading id="liability" number={19}>
        ...
        {/* 20. INDEMNIFICATION */}
        <section className="mt-12 space-y-4 text-sm leading-relaxed text-gray-700">
          <SectionHeading id="indemnification" number={20}>Indemnification</SectionHeading>
          <p>
        ...
        {/* 21. USER DATA */}
        <section className="mt-12 space-y-4 text-sm leading-relaxed text-gray-700">
          <SectionHeading id="userdata" number={21}>User data</SectionHeading>
          <p>
        ...
        <section className="mt-12 space-y-4 text-sm leading-relaxed text-gray-700">
          <SectionHeading id="electronic" number={22}>
        ...
        <section className="mt-12 space-y-4 text-sm leading-relaxed text-gray-700">
          <SectionHeading id="california" number={23}>
        ...
        {/* 24. MISCELLANEOUS */}
        <section className="mt-12 space-y-4 text-sm leading-relaxed text-gray-700">
          <SectionHeading id="misc" number={24}>Miscellaneous</SectionHeading>
          <p>
            ...
            of a provision of these Legal Terms is determined to be
        ...
        {/* 25. CONTACT US */}
        <section className="mt-12 space-y-4 text-sm leading-relaxed text-gray-700">
          <SectionHeading id="contact" number={25}>Contact us</SectionHeading>
          <p>
          ...
          <address className="not-italic">
            <strong className="text-[#0C1F3F]">FieldSlate</strong>
            <br />
            322 Yates Dr
            <br />
            Santa Rosa, CA 95405
